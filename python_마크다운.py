...
# <br>
<br>을 입력하면 엔터처럼 한줄씩 띄어쓰기가 된다.

<font color = 'blue'> # 파란색 글자로 출력할 수 있다.
 <font color=navy> # 네이비색 글자로 출력할 수 있다.
 ex ) <font color=navy>1. Review: Frequentist's Methods </font>
<font color = 'red'> # 빨간색 글자로 출력할 수 있다.
<font color = '#CC3D3D'> # 붉은색 글자로 출력할 수 있다.
<font color='darkgreen'> # 녹색
     -> 뒤에 </font>로 닫아주면 닫은 곳까지의 글자만 글 색깔이 들어간다
